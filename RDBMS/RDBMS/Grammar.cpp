...
void Grammar::close_cmd(
	std::string input,
	std::vector<Relation>& tables){}
void Grammar::write_cmd(
	std::string input,
	std::vector<Relation>& tables){}
void Grammar::exit_cmd(
	std::string input,
	std::vector<Relation>& tables){}
void Grammar::show_cmd(
	std::string input,
	std::vector<Relation>& tables){}
...
Relation Grammar::find_relation(
	std::string input,
	std::vector<Relation>& tables){
...
Relation Grammar::selection(
	...
	while (std::regex_search(condition, m, reg_conj)){
		...
		condition = m.suffix().str(); //possibly change position of this to assignment at top of while loop (John)
	}
...
Relation Grammar::projection(
	...
	while (std::regex_search(attr_list, m, reg_attr_name)){
		...
		attr_list = m.suffix().str(); //possibly change position of this to assignment at top of while loop (John)
	}
